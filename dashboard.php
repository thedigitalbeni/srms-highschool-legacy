...
?>
    ...
    <head>
        ...
        <title>DSA SR System | Dashboard</title>
                ...
                <div class="content-container">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div" style="background-color: #fff; ">
                                <div class="col-sm-6">
                                    <h2 class="title" style="color: red; ">Dashboard</h2>
    ...
    <div class="foot">
        <footer>
            <p>Copy right @ Dream Success Academy</p>
