<div class="left-sidebar bg-black-300 box-shadow " style="background-color: #4da1d5; box-shadow: 0 0 10px rgba(0, 0, 0, 0.9);">
    <div class="sidebar-content">
        <div class="user-info closed">
            <img src="images/d.jpg" alt="John Doe" class="img-circle profile-img" style="width: 100px;
            height: 100px;
            border-radius: 50%;">
            <h6 class="title">Dream Success Academy</h6>
